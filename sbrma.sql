...
create table matcha_data_spool (
...
create table matcha_data_spool_matching (
  id bigint identity(1,1) primary key,
  id_kegiatan int null, -- foreign key ke table matcha_kegiatan
  cluster_id bigint null,
  record_id bigint null,
  perusahaan_id bigint null, -- foreign key ke table business_perusahaan
  score float null -- nilai hasil matching
)

create table matcha_data_spool_matching_old (
  id bigint identity(1,1) primary key,
  id_kegiatan int null, -- foreign key ke table matcha_kegiatan
  cluster_id bigint null,
  record_id bigint null,
...
create table matcha_user_roles (
...
create table matcha_alokasi_petugas_matching (
...
create table matcha_matching_results (
    id int identity(1,1) primary key,
    id_spool int not null,
    idsbr int not null,
    id_kegiatan int not null,
...
create table matcha_alokasi_petugas_assessment (
...
create table matcha_assessment_results_email (
    id int identity(1,1) primary key,
    id_alokasi int not null,
...
create table matcha_assessment_results_fax (
    id int identity(1,1) primary key,
    id_alokasi int not null,
...
create table matcha_assessment_results_telepon (
    id int identity(1,1) primary key,
    id_alokasi int not null,
...
create table matcha_assessment_results_web (
    id int identity(1,1) primary key,
    id_alokasi int not null,
...
create table matcha_assessment_results_kontak_perusahaan (
    id int identity(1,1) primary key,
    id_alokasi int not null,
...
create table matcha_assessment_results_aktivitas (
    id int identity(1,1) primary key,
    id_alokasi int not null,
...
create table matcha_assessment_results_produk (
    id int identity(1,1) primary key,
    id_alokasi int not null,
